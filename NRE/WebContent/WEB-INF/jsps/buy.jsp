...
<body>
	...
	<div class="container" style="margin-top: 50px">
		<div class="row">
			<div class="col-md-12">
				<h2>Available properties</h2><hr>
				<a href="${pageContext.request.contextPath }/Show-Property-Rates" name="prates">Property rates per square feet</a><br>
				<a href="#" name="aproperties">Browse property</a>
			</div>
		</div>
	</div>
</body>
