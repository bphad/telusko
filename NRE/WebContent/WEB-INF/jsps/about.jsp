...
<body>
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="${pageContext.request.contextPath}/Show-Contact-Us">CONTACT US</a></li>
		</ul>
		</div>
	</nav>
	...
	<div class="container" style="margin-top: 50px">
 	<div class="row">
			<div class="col-md-12">
				<h2>About us </h2><hr>
					<p>We at Nasikrealestates.com helps people to find their dream home, provides investment assistance, helps people to buy,sell,rent,develop.   </p>
					<b>Our Mission -</b>
					<p>Make nasik a better place..</p>
					<b>Balasaheb B. Phad</b><br>
					<b>email:bphad@nasikrealestates.com</b>
			</div>
		</div>
	</div>
</body>
