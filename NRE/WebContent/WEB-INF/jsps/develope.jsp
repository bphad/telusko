...
<body>
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="${pageContext.request.contextPath}/Show-Develope">DEVELOPE</a></li>
	...
	<div class="container" style="margin-top: 50px">
		<div class="row">
			<div class="col-md-12">
				...
				<h3>Cunstruction partner</h3>
				<span>
					<a href="#"><b>Backbencher's Cunstruction- Vinod Salunke-Nasik </b></a><br>
					<b>Current projects :</b><br>
					<b>Contact :</b>+91-9172929928<br>
					<b>Email :</b>vinodsalunke@gmail.com<br>
				</span>
			</div>
		</div>
	</div>
